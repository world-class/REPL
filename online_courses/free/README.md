...
- [Automate the Boring Stuff with Python Programming](https://www.udemy.com/course/automate/) - Udemy. Offered by Al Sweigert. - This course can be accessed for free with [monthly coupon codes](https://inventwithpython.com/automateudemy) that are available. "A practical programming course for anyone who want to improve their productivity."_
